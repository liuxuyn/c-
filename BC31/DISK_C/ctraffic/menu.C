...
/*******************菜单内容***********************/
static char *czsm[]={"F1 操作说明","F2 功能介绍","F3 关于团队","ENTER确认分析",
                     "BLANK播放暂停","BACK 后退删除 ","ESC 退出"};
static char *gnjs[]={"1、智能十字仿真 ","2、常规十字仿真 ","3、智能丁字仿真 ",
                     "4、常规丁字仿真","5、时间对比 ","6、报表分析 "};
static char *gytd[]={" 自动化1003班","  “成 员”","   李 鑫","   国悦婷"," ！注意要开始啦！"};

/*********************************************************
*函数名：void pullmenuup                                 *
*功能：收起菜单                                          *
*参数：bt按钮指针,buffer为保存图像的内存首指针            *
**********************************************************/
...
*函数名：void handlemenu                                   *
*功能：菜单处理函数                                        *
*参数：bt按钮指针,buffer为保存图像的内存首指针，n为菜单行数  *
************************************************************/
...
/**********************************************************
*函数名：void pullmenudown                                 *
*功能：拉下菜单                                            *
*参数：bt按钮指针,buffer为保存图像的内存首指针，word菜单内容 *
************************************************************/
...
/**********************************************************
*函数名：void do_carinit_mouse_move                        *
*功能：车辆初始化界面鼠标没按下的操作                       *
*参数：void                                                *
************************************************************/
...
void do_initcar(BOX *box,int n)
{
    ...
    msg("请在路面预览窗口内输入路口车辆，每个路口车辆上限为24辆");
    show_mouse();
    while(1)
    {
...
/**********************************************************
*函数名：void go_msg_stay                                   *
*功能：当鼠标在确定上时保持显示提示的函数（共用）            *
*参数：void                                                *
************************************************************/
...
/**********************************************************
*函数名：int init_cargo_s                                  *
*功能：点击确定后的判断数据和进入下一界面的函数（十字）      *
*参数：car_num车数量数组首地址，box为输入框指针             *
************************************************************/
...
/**********************************************************
*函数名：int init_cargo_d                                  *
*功能：点击确定后的判断数据和进入下一界面的函数（丁字）      *
*参数：car_num车数量数组首地址，box为输入框指针             *
************************************************************/
...
/**********************************************************
*函数名：int Win_IntOrNor_s                                *
*功能：智能与常规仿真模式选择界面（十字）                    *
*参数：car_num为车辆数量数组首地址，car为车结构指针          *
************************************************************/
